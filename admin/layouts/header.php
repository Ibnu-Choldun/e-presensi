          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="<?= base_url('admin/profil/profil.php') ?>" class="dropdown-item">Profil</a>
          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/beranda/beranda.php') ?>" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/karyawan/karyawan.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/jabatan/jabatan.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/presensi/rekap.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/absensi/absensi.php') ?>" >
